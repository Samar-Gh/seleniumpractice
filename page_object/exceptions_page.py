...
class ExceptionsPage(BasePage):
    ...
    def add_second_food(self):
        super()._type(self.__row_2_input_element, "Pasta")
    ...
    def modify_row_1_input(self, text):
    ...
    def are_instructions_displayed(self) -> bool:
        return super().is_displayed(self.__instructions_element)
